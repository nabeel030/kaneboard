...
function submit() {
  // Store endpoint for resource is POST /teams (same URL as index)
  router.post(teamRoutes.index().url, form, {
    preserveScroll: true,
  });
}
</script>
    ...
    <div class="max-w-xl p-4">
      ...
      <form class="mt-4 space-y-3" @submit.prevent="submit">
        ...
        <div class="flex gap-2">
          ...
          <Link :href="teamRoutes.index()" class="rounded border px-3 py-2 text-sm">
            Cancel
          </Link>
        </div>
      </form>
